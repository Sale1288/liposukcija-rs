...
//------------------------------------------------------------------------          
    $('#subscribe_form').validate({
        ...
        messages: {
            email: {
                required: "Potrebno je da unesete pravilnu email adresu",
                email: "Molimo da proverite unesenu email adresu"
            }
        },
        ...
        if($(this).valid()){
            ...
            $.ajax({
                ...
                error: function() {
					...
					//Use modal popups to display messages
					$('#modalMessage .modal-title').html('<i class="icon icon-ban"></i>Oops!<br>Nešto nije uredu!');
					$('#modalMessage').modal('show');
...
//------------------------------------------------------------------------------------		  
    $('#contact_form').validate({
        ...
        messages: {
            name: "Koje je vaše ime?",
            message: "Unesite vašu poruku",
            email: {
                required: "Koja je vaša email adresa",
                email: "Molimo da unesete tačnu email adresu"
            }
        },
        ...
        if($(this).valid()){
            ...
            $.ajax({
                ...
                success: function() {
					...
					//Use modal popups to display messages
					$('#modalMessage .modal-title').html('<i class="icon icon-envelope-open"></i>Uspešno!<br>Vaša poruka je uspešno poslata!');
					$('#modalMessage').modal('show');
                },
                error: function() {
                    $('#contact_submit').button('reset');
					...
					//Use modal popups to display messages
					$('#modalMessage .modal-title').html('<i class="icon icon-ban"></i>Greška!<br>Došlo je do greške u slanju!');
					$('#modalMessage').modal('show');
                }
            });
        } else {
